...
//       bcrypt.compare(req.body.password, row.Password).then((areMatch) => {
//         if (!areMatch)
//           return res.status(400).send({
//             status: 'error',
//             message:
...
//         bot.userToken = token;
//         if (bot.chatId) {
//           const sendSuccessUrl =
//             `https://api.telegram.org/bot${config.telegramApiToken}/sendmessage?text=You%` +
